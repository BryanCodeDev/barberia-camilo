...
const ServiceCard = ({ service, index }) => {
  ...
  return (
    <div
      className="relative group bg-[#0A0A0A] rounded-md p-6 border border-[#2A2A2A] hover:border-[#C9A860] hover:-translate-y-2 transition-all duration-300 ease-out shadow-[0_4px_20px_rgba(0,0,0,0.15)] hover:shadow-[0_20px_45px_rgba(201,168,96,0.15)] overflow-hidden"
    ...
    >
      ...
      <Scissors className="absolute -right-4 -bottom-4 h-28 w-28 text-white/[0.03] rotate-12 group-hover:rotate-[24deg] group-hover:scale-110 transition-transform duration-500 pointer-events-none" />
      ...
      <div className="relative flex items-start mb-4">
        <div className="bg-[#1A1A1A] p-2.5 rounded-sm mr-3 border border-[#2A2A2A] group-hover:bg-[#C9A860] group-hover:border-[#C9A860] transition-colors duration-300">
          <Scissors className="h-4 w-4 text-[#C9A860] group-hover:text-black transition-colors duration-300" />
        </div>
      ...
      <button
        ...
        className="relative w-full flex items-center justify-center gap-2 py-3 px-4 rounded-sm font-semibold text-sm uppercase tracking-wide bg-[#C9A860] text-black hover:bg-[#E0C47A] transition-all duration-300 group/btn overflow-hidden"
      >
